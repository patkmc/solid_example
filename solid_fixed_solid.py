...
# with applying dependency inversion principle:
...
def fetch_field(document: str, field_to_fetch: str, doc_service: BaseDocumentService) -> str:
...
fetch_field(_document, _field_to_fetch, document_services["external"])
